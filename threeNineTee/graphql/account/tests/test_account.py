...
@patch("threeNineTee.account.emails._send_account_confirmation_email")
...
@patch("threeNineTee.account.emails._send_set_password_email")
...
@patch("threeNineTee.account.emails._send_set_user_password_email_with_url.delay")
...
@patch("threeNineTee.account.emails._send_delete_confirmation_email")
...
@freeze_time("2018-05-31 12:00:01")
@patch("threeNineTee.account.emails._send_account_delete_confirmation_email_with_url.delay")
...
@patch(
    "threeNineTee.graphql.account.utils.account_events.staff_user_deleted_a_customer_event"
)
...
@patch("threeNineTee.account.emails._send_password_reset_email")
...
@freeze_time("2018-05-31 12:00:01")
@patch("threeNineTee.graphql.account.mutations.base.match_orders_with_new_user")
def test_account_confirmation(
    match_orders_with_new_user_mock, api_client, customer_user
):
    customer_user.is_active = False
    print("account/tests/test_account.py - 3")
    customer_user.save()
    ...
    print("account/tests/test_account.py - 1")
    response = api_client.post_graphql(CONFIRM_ACCOUNT_MUTATION, variables)
    print("account/tests/test_account.py - 2")
    content = get_graphql_content(response)
...
def test_user_avatar_update_mutation(monkeypatch, staff_api_client, media_root):
    ...
    monkeypatch.setattr(
        (
            "threeNineTee.graphql.account.mutations.staff."
