...
class VoucherInput(graphene.InputObjectType):
    status = graphene.Boolean(
        description="Status of voucher whether its active or not"
    )
    actual_price=PositiveDecimal(
            description="Actual Price of product."
        )
    max_checkout_items_quantity = graphene.Int(
            description="Maximum quantity of checkout items to apply the voucher."
        )
