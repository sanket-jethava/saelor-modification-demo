...
@patch("threeNineTee.graphql.order.mutations.draft_orders.add_variant_to_draft_order")
...
@patch("threeNineTee.graphql.order.mutations.draft_orders.update_order_prices")
...
@patch("threeNineTee.plugins.base_plugin.BasePlugin.order_updated")
...
@patch("threeNineTee.graphql.order.mutations.orders.cancel_order")
@patch("threeNineTee.graphql.order.mutations.orders.clean_order_cancel")
...
@patch("threeNineTee.graphql.order.bulk_mutations.orders.cancel_order")
