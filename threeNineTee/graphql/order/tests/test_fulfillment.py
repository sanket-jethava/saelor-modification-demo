...
@patch("threeNineTee.graphql.order.mutations.fulfillments.create_fulfillments")
...
@patch("threeNineTee.graphql.order.mutations.fulfillments.create_fulfillments", autospec=True)
...
@patch("threeNineTee.order.emails.send_fulfillment_update.delay")
...
@patch("threeNineTee.order.actions.send_fulfillment_confirmation_to_customer", autospec=True)
