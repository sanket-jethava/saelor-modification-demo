...
class ShippingZoneMixin:
    ...
    def clean_input(cls, info, instance, data, input_cls=None):
        ...
        print("duplicates_ids",duplicates_ids)
        if duplicates_ids:
            error_msg = (
                "The same object cannot be in both lists "
                "for adding and removing items."
            )
            print("if duplicates_ids")
    ...
    def clean_default(cls, instance, data):
        ...
        if default:
            if default_shipping_zone_exists(instance.pk):
                ...
                print("data['countries']",data["countries"])
        else:
            data["default"] = False
        print(data)
        return data
