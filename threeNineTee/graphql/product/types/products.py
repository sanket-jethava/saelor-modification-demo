...
class AllCategoryList(DjangoObjectType):
    class Meta:
        model = models.Category
        fields = ('id','name','level','parent','description')

class AllCategoryNameList(DjangoObjectType):
    class Meta:
        model = models.Category
        fields = ('id','name')
...
class ProductVariant(CountableDjangoObjectType):
    ...
    class Meta:
        ...
        only_fields = ["id", "name", "product", "sku", "track_inventory", "weight","size","region","color"]
