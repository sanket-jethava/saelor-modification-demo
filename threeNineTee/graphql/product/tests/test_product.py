...
def test_product_query_error_when_id_and_slug_provided(
    ...
    assert graphql_log_handler.messages == [
        "threeNineTee.graphql.errors.handled[ERROR].GraphQLError"
    ]
...
def test_product_create_with_collections_webhook(
    ...
    monkeypatch.setattr(
        "threeNineTee.plugins.manager.PluginsManager.product_created",
...
@freeze_time("2020-03-18 12:00:00")
@patch("threeNineTee.plugins.manager.PluginsManager.product_updated")
...
@patch("threeNineTee.product.tasks.update_variants_names.delay")
...
@patch("threeNineTee.product.tasks._update_variants_names")
