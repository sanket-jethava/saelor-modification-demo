...
class CategoryInput(graphene.InputObjectType):
    ...
    background_image = graphene.String(description="Background image file.")
...
class CategoryCreate(ModelMutation):
    class Arguments:
        input = CategoryInput(
            required=False, description="Fields required to create a category."
        )
    ...
    def clean_input(cls, info, instance, data):
        ...
        if parent_id:
            ...
            # try:
            #     parent = models.Category.objects.get(id=parent_id)
            #     cleaned_input["parent"] = parent
            # except:
            #     pass
        ...
        if data.get("background_image"):
            ...
            cleaned_input["background_image"]=image_data
...
class ProductCreate(ModelMutation):
    ...
    def clean_sku(cls, product_type, cleaned_input):
        ...
        http://docs.getthreeNineTee.com/en/latest/architecture/products.html#product-types
        """
...
class ProductVariantInput(graphene.InputObjectType):
    ...
    color = graphene.String(description="Color of variant.")
    size = graphene.String(description="Size of variant.")
    region = graphene.String(description="Region of variant.")
...
class AttributeAssignmentMixinForProductVariant:
    """Handles cleaning of the attribute input and creating the proper relations.
    ...
    def save(cls, instance: T_INSTANCE, cleaned_input: T_INPUT_MAP):
        ...
        attribute_id = from_global_id_strict_type(cleaned_input[0]['id'], only_type="Attribute", field="pk")
        attribute_obj = models.Attribute.objects.get(id=attribute_id)
        attribute_values = cls._pre_save_values(attribute_obj, cleaned_input[0]['values'])
...
class ProductVariantCreate(ModelMutation):
    ...
    def clean_attributes(
        ...
        attributes = AttributeAssignmentMixinForProductVariant.clean_input(
    ...
    def clean_input(
        ...
        cleaned_input = super().clean_input(info, models.ProductVariant, data)
    ...
    def save(cls, info, instance, cleaned_input):
        ...
        if attributes:
            ...
            AttributeAssignmentMixinForProductVariant.save(instance, attributes)
