...
#Checkout address
class CheckoutAddress(CountableDjangoObjectType):
    class Meta:
        model = Address
        fields = ('id', 'first_name', 'country', 'phone','street_address_1','state', 'city','postal_code', 'type_of_address', 'is_billing','shipping_id')
