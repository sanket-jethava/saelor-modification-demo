...
@mock.patch("threeNineTee.plugins.webhook.plugin.trigger_webhooks_for_event.delay")
def test_checkout_create_triggers_webhooks(
    ...
    settings.PLUGINS = ["threeNineTee.plugins.webhook.plugin.WebhookPlugin"]
...
@mock.patch(
    "threeNineTee.graphql.checkout.mutations.update_checkout_shipping_method_if_invalid",
...
@patch("threeNineTee.graphql.checkout.mutations.clean_shipping_method")
