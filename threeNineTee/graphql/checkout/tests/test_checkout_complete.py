...
@patch(
    "threeNineTee.payment.gateways.dummy_credit_card.plugin."
...
@patch("threeNineTee.checkout.complete_checkout.gateway.refund")
...
@patch("threeNineTee.checkout.complete_checkout.gateway.void")
...
@patch("threeNineTee.checkout.complete_checkout.gateway.payment_refund_or_void")
...
@patch("threeNineTee.checkout.complete_checkout._create_order")
