...
IMAGES_MAPPING = {
    61: ["threeNineTeedemoproduct_paints_01.png"],
    62: ["threeNineTeedemoproduct_paints_02.png"],
    63: ["threeNineTeedemoproduct_paints_03.png"],
    64: ["threeNineTeedemoproduct_paints_04.png"],
    65: ["threeNineTeedemoproduct_paints_05.png"],
    71: ["threeNineTeedemoproduct_fd_juice_06.png"],
    72: ["threeNineTeedemoproduct_fd_juice_06.png"],  # FIXME inproper image
    73: ["threeNineTeedemoproduct_fd_juice_05.png"],
    74: ["threeNineTeedemoproduct_fd_juice_01.png"],
    75: ["threeNineTeedemoproduct_fd_juice_03.png"],  # FIXME inproper image
    76: ["threeNineTeedemoproduct_fd_juice_02.png"],  # FIXME inproper image
    77: ["threeNineTeedemoproduct_fd_juice_03.png"],
    78: ["threeNineTeedemoproduct_fd_juice_04.png"],
    79: ["threeNineTeedemoproduct_fd_juice_02.png"],
    81: ["threeNineTeedemoproduct_wine-red.png"],
    82: ["threeNineTeedemoproduct_wine-white.png"],
    83: ["threeNineTeedemoproduct_beer-02_1.png", "threeNineTeedemoproduct_beer-02_2.png"],
    84: ["threeNineTeedemoproduct_beer-01_1.png", "threeNineTeedemoproduct_beer-01_2.png"],
    85: ["threeNineTeedemoproduct_cuschion01.png"],
    86: ["threeNineTeedemoproduct_cuschion02.png"],
    87: [
        "threeNineTeedemoproduct_sneakers_01_1.png",
        "threeNineTeedemoproduct_sneakers_01_2.png",
        "threeNineTeedemoproduct_sneakers_01_3.png",
        "threeNineTeedemoproduct_sneakers_01_4.png",
    ],
    88: [
        "threeNineTeedemoproduct_sneakers_02_1.png",
        "threeNineTeedemoproduct_sneakers_02_2.png",
        "threeNineTeedemoproduct_sneakers_02_3.png",
        "threeNineTeedemoproduct_sneakers_02_4.png",
    ],
    89: ["threeNineTeedemoproduct_cl_boot07_1.png", "threeNineTeedemoproduct_cl_boot07_2.png"],
    107: ["threeNineTeedemoproduct_cl_polo01.png"],
    108: ["threeNineTeedemoproduct_cl_polo02.png"],
    109: ["threeNineTeedemoproduct_cl_polo03-woman.png"],
    110: ["threeNineTeedemoproduct_cl_polo04-woman.png"],
    111: [
        "threeNineTeedemoproduct_cl_boot01_1.png",
        "threeNineTeedemoproduct_cl_boot01_2.png",
        "threeNineTeedemoproduct_cl_boot01_3.png",
    ],
    112: ["threeNineTeedemoproduct_cl_boot03_1.png", "threeNineTeedemoproduct_cl_boot03_2.png"],
    113: ["threeNineTeedemoproduct_cl_boot06_1.png", "threeNineTeedemoproduct_cl_boot06_2.png"],
    114: [
        "threeNineTeedemoproduct_cl_boot06_1.png",
        "threeNineTeedemoproduct_cl_boot06_2.png",
    ],  # FIXME incorrect image
    115: ["threeNineTeedemoproduct_cl_bogo01_1.png"],
    116: ["threeNineTeedemoproduct_cl_bogo02_1.png"],
    117: ["threeNineTeedemoproduct_cl_bogo03_1.png"],
    118: ["threeNineTeedemoproduct_cl_bogo04_1.png", "threeNineTeedemoproduct_cl_bogo04_2.png"],
    119: ["threeNineTee-digital-03_1.png"],
    120: ["threeNineTee-digital-03_2.png"],
    121: ["threeNineTee-digital-03_3.png"],
    122: ["threeNineTee-digital-03_4.png"],
    123: ["threeNineTee-digital-03_5.png"],
    124: ["threeNineTee-digital-03_6.png"],
}
...
def create_products_by_schema(placeholder_dir, create_images):
    path = os.path.join(
        settings.PROJECT_ROOT, "threeNineTee", "static", "populatedb_data.json"
    )
    with open(path) as f:
...
class threeNineTeeProvider(BaseProvider):
    def money(self):
...
fake.add_provider(threeNineTeeProvider)
...
# fake customers.
@patch("threeNineTee.order.emails.send_payment_confirmation.delay")
...
def create_page():
    ...
    <p>threeNineTee is a rapidly-growing open source e-commerce platform that has served
       ...
       to make threeNineTee a full-functionality open source e-commerce.</p>
    <p><a href="https://github.com/mirumee/threeNineTee">Get threeNineTee today!</a></p>
    """
    content_json = {
        "blocks": [
            {
            ...
            },
            {
                "key": "",
                "data": {},
                "text": "threeNineTee is a rapidly-growing open source e-commerce platform "
                ...
                "written in React to make threeNineTee a full-functionality "
        ...
        "entityMap": {
            "0": {
                "data": {"url": "https://github.com/mirumee/threeNineTee"},
                "type": "LINK",
                "mutability": "MUTABLE",
            }
        },
...
def create_menus():
    ...
    item_threeNineTee = bottom_menu.items.get_or_create(name="threeNineTee", url="/")[0]

    page = Page.objects.order_by("?")[0]
    item_threeNineTee.children.get_or_create(name=page.title, page=page, menu=bottom_menu)

    api_url = build_absolute_uri(reverse("api"))
    item_threeNineTee.children.get_or_create(
