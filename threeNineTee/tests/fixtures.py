...
def setup_vatlayer(settings):
    settings.PLUGINS = ["threeNineTee.plugins.vatlayer.plugin.VatlayerPlugin"]
    data = {
        "active": True,
...
def site_settings(db, settings) -> SiteSettings:
    ...
    threeNineTee.site.models.SiteSettings have a one-to-one relationship and a site
    ...
    return {
        "blocks": [
            ...
            },
            {
                ...
                "data": {},
                "text": (
                    "threeNineTee is a rapidly-growing open source e-commerce platform "
        ...
        "entityMap": {
            "0": {
                "data": {"href": "https://github.com/mirumee/threeNineTee"},
                "type": "LINK",
                "mutability": "MUTABLE",
            }
        },
    ...
    return {
        "blocks": [
            ...
            },
            {
                ...
                "data": {},
                "text": (
                    "threeNineTee is powered by a GraphQL server running on "
...
def mock_get_manager(mocker, fake_payment_interface):
    mgr = mocker.patch(
        "threeNineTee.payment.gateway.get_plugins_manager",
        autospec=True,
