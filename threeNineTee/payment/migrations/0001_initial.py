            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                threeNineTee.payment.TransactionError("incorrect_number"),
                                "incorrect_number",
                            ),
                            (
                                threeNineTee.payment.TransactionError("invalid_number"),
                                "invalid_number",
                            ),
                            (
                                threeNineTee.payment.TransactionError("incorrect_cvv"),
                                "incorrect_cvv",
                            ),
                            (
                                threeNineTee.payment.TransactionError("invalid_cvv"),
                                "invalid_cvv",
                            ),
                            (
                                threeNineTee.payment.TransactionError("incorrect_zip"),
                                "incorrect_zip",
                            ),
                            (
                                threeNineTee.payment.TransactionError("incorrect_address"),
                                "incorrect_address",
                            ),
                            (
                                threeNineTee.payment.TransactionError("invalid_expiry_date"),
                                "invalid_expiry_date",
                            ),
                            (threeNineTee.payment.TransactionError("expired"), "expired"),
                            (
                                threeNineTee.payment.TransactionError("processing_error"),
                                "processing_error",
                            ),
                            (threeNineTee.payment.TransactionError("declined"), "declined"),
                        ],
                        max_length=256,
                        null=True,
                    ),
