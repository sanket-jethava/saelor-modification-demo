...
from threeNineTee.plugins.base_plugin import BasePlugin, ConfigurationTypeField
...
class BraintreeGatewayPlugin(BasePlugin):
    ...
    CONFIG_STRUCTURE = {
        ...
        "Use sandbox": {
            ...
            "help_text": "Determines if threeNineTee should use Braintree sandbox API.",
            "label": "Use sandbox",
        },
        "Store customers card": {
            "type": ConfigurationTypeField.BOOLEAN,
            "help_text": "Determines if threeNineTee should store cards on payments"
            " in Braintree customer.",
            "label": "Store customers card",
        },
        "Automatic payment capture": {
            "type": ConfigurationTypeField.BOOLEAN,
            "help_text": "Determines if threeNineTee should automaticaly capture payments.",
            "label": "Automatic payment capture",
        },
        "Require 3D secure": {
            "type": ConfigurationTypeField.BOOLEAN,
            "help_text": "Determines if threeNineTee should enforce 3D secure during payment.",
