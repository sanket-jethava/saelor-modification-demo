...
def test_get_error_for_client(braintree_error, monkeypatch):
    ...
    monkeypatch.setattr("threeNineTee.payment.gateways.braintree.ERROR_CODES_WHITELIST", {})
    assert get_error_for_client([error]) == DEFAULT_ERROR

    monkeypatch.setattr(
        "threeNineTee.payment.gateways.braintree.ERROR_CODES_WHITELIST",
...
@patch("threeNineTee.payment.gateways.braintree.get_braintree_gateway")
