...
def adyen_plugin(settings):
    def fun(
        ...
        merchant_account = merchant_account or "threeNineTeeECOM"
        ...
        settings.PLUGINS = ["threeNineTee.payment.gateways.adyen.plugin.AdyenGatewayPlugin"]
        manager = get_plugins_manager()

        with mock.patch("threeNineTee.payment.gateways.adyen.utils.apple_pay.requests.post"):
...
def notification():
    def fun(
        ...
        return {
            ...
            "merchantAccountCode": "threeNineTeeECOM",
...
def notification_with_hmac_signature():
    return {
        ...
        "merchantAccountCode": "threeNineTeePOS",
