...
class AdyenGatewayPlugin(BasePlugin):
    ...
    CONFIG_STRUCTURE = {
        ...
        "adyen-auto-capture": {
            ...
            "help_text": (
                ...
                " threeNineTee doesn't support the delayed capture Adyen feature."
            ),
        ...
        "auto-capture": {
            "type": ConfigurationTypeField.BOOLEAN,
            "help_text": (
                "If enabled, threeNineTee will automatically capture funds. If, disabled, the"
        ...
        "hmac-secret-key": {
            ...
            "help_text": (
                ...
                "ions-in-your-customer-area. The threeNineTee webhook url is "
        ...
        "notification-user": {
            ...
            "help_text": (
                ...
                "The threeNineTee webhook url is "
                "http(s)://<your-backend-url>/plugins/mirumee.payments.adyen/webhooks/"
            ),
        ...
        "enable-native-3d-secure": {
            "type": ConfigurationTypeField.BOOLEAN,
            "help_text": (
                "threeNineTee uses 3D Secure redirect authentication by default. If you want"
    ...
    def _process_additional_action(self, payment_information: "PaymentData", kind: str):
        ...
        if result_code in PENDING_STATUSES:
            ...
            # For enabled auto_capture on threeNineTee side we need to proceed an additional
            # action
            kind = TransactionKind.CAPTURE
            result = call_capture(
                payment_information=payment_information,
