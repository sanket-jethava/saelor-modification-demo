...
@patch("threeNineTee.order.emails.send_fulfillment_confirmation.delay")
...
@patch("threeNineTee.order.actions.send_order_canceled_confirmation")
...
@patch("threeNineTee.order.actions.send_order_refunded_confirmation")
...
@patch("threeNineTee.order.actions.emails.send_fulfillment_confirmation")
@patch("threeNineTee.order.utils.get_default_digital_content_settings")
