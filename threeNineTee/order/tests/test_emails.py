...
@mock.patch("threeNineTee.order.emails.send_templated_mail")
...
@mock.patch("threeNineTee.order.emails.send_order_refunded.delay")
...
@mock.patch("threeNineTee.order.emails.send_order_canceled.delay")
