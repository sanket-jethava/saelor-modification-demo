...
class ProductVariant(SortableModel, ModelWithMetadata):
    ...
    size=models.CharField(max_length=255, choices=SIZE_CHOICES,default='m', blank=True,null=True)
    ...
    region=models.CharField(max_length=255,choices=REGION_CHOICES,default='all_region', blank=True,null=True)
...
class Attribute(ModelWithMetadata):
    ...
    attribute_code =models.CharField(max_length=50 ,default=None, blank=True,null=True)
