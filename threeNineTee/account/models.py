...
class Address(models.Model):
    ...
    # shipping_id = models.ForeignKey(max_length=20, blank=True, null=True)
    type_of_address = models.CharField(max_length=20, blank=True, null=True)
...
class b2bSubUserRelation(models.Model):
    parentb2b_user_id = models.BigIntegerField(blank=False)
    subb2b_user_id = models.BigIntegerField(blank=False)

class TokenActivity(models.Model):
    user_id = models.BigIntegerField(blank=False)
    date = models.DateField(default=datetime.date.today,editable=False,blank=True,null=True)
    action = models.TextField(blank=False)
    token_amount = models.TextField(blank=False)

class SocialMediaLinks(models.Model):
    user_id = models.BigIntegerField(blank=False,unique=True)
    dribble_link = models.TextField(blank=True)
...
class Package(models.Model):
    ...
    date_created = models.DateField(default=datetime.date.today,editable=False,blank=True,null=True)
    is_active = models.BooleanField(default=False)

class loginOTP(models.Model):
    otp = models.TextField(blank=False)
    mobile = models.TextField(blank=False)

class LoginSummary(models.Model):
    user_id = models.IntegerField(blank=True)
    date = models.DateField(default=datetime.date.today,editable=False,blank=True,null=True)
    login_time = models.TimeField(default=timezone.now, editable=False,blank=True,null=True)
    logout_time = models.TimeField(default=None, editable=False,blank=True,null=True)
    device_type = models.CharField(max_length=50,blank=True,null=True)
    login_token_key = models.TextField(max_length=280, default=None, null=True)

class User(PermissionsMixin, ModelWithMetadata, AbstractBaseUser):
    parent_id = models.BigIntegerField(default=0)
    company_zipcode = models.TextField(max_length=10,blank=True)
    company_state = models.TextField(max_length=50,blank=True)
    company_city = models.TextField(max_length=50,blank=True)
    company_country = models.TextField(max_length=50,blank=True)
    company_phone = models.TextField(max_length=10,blank=True)
    company_phone_code = models.TextField(max_length=3,blank=True)
    upi_id = models.TextField(max_length=300,blank=True)
    bio = models.TextField(max_length=300,blank=True)
    social_media_id = models.IntegerField(blank=True,default=0)
    company_name = models.TextField(max_length=100,blank=True)
    contact_person = models.TextField(max_length=100,blank=True)
    is_b2buser = models.BooleanField(default=False)
    is_artist = models.BooleanField(default=False)
    is_buyer = models.BooleanField(default=False)
    available_token = models.BigIntegerField(default=0)
    pan_number = models.TextField(max_length=10,blank=True)
    gst_number = models.TextField(max_length=15,blank=True)
    gender = models.TextField(max_length=6, blank=True)
    package_id = models.BigIntegerField(default=0)
    country_code = models.TextField(max_length=3,blank=True)
    phonenumber = models.TextField(max_length=10,blank=True,unique=True)
    is_loginwith_google = models.BooleanField(default=False)
    is_loginwith_facebook = models.BooleanField(default=False)
