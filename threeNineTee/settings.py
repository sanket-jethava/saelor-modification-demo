...
ROOT_URLCONF = "threeNineTee.urls"

WSGI_APPLICATION = "threeNineTee.wsgi.application"
...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://999Tee:sanket@localhost:5432/999Tee", conn_max_age=600
    )
}
...
EMAIL_URL = "smtp://blindhelper2020@gmail.com:Blindhelper@2021@smtp.gmail.com:465/?ssl=True"
...
#Chage
DEFAULT_FROM_EMAIL = "blindhelper2020@gmail.com"
...
STATICFILES_DIRS = [
    ("images", os.path.join(PROJECT_ROOT, "threeNineTee", "static", "images"))
]
STATICFILES_FINDERS = [
...
context_processors = [
    ...
    "threeNineTee.site.context_processors.site",
...
MIDDLEWARE = [
    ...
    "threeNineTee.core.middleware.request_time",
    "threeNineTee.core.middleware.discounts",
    "threeNineTee.core.middleware.google_analytics",
    "threeNineTee.core.middleware.country",
    "threeNineTee.core.middleware.currency",
    "threeNineTee.core.middleware.site",
    "threeNineTee.core.middleware.plugins",
    "threeNineTee.core.middleware.jwt_refresh_token_middleware",
...
INSTALLED_APPS = [
    ...
    # Local apps
    "threeNineTee.plugins",
    "threeNineTee.account",
    "threeNineTee.discount",
    "threeNineTee.giftcard",
    "threeNineTee.product",
    "threeNineTee.checkout",
    "threeNineTee.core",
    "threeNineTee.csv",
    "threeNineTee.graphql",
    "threeNineTee.menu",
    "threeNineTee.order",
    "threeNineTee.invoice",
    "threeNineTee.seo",
    "threeNineTee.shipping",
    "threeNineTee.search",
    "threeNineTee.site",
    "threeNineTee.data_feeds",
    "threeNineTee.page",
    "threeNineTee.payment",
    "threeNineTee.warehouse",
    "threeNineTee.webhook",
    "threeNineTee.wishlist",
    "threeNineTee.app",
	"threeNineTee.marketing",
	"threeNineTee.blog_management",
	"threeNineTee.job_management",
...
if ENABLE_DEBUG_TOOLBAR:
    ...
    try:
        ...
        MIDDLEWARE.append("threeNineTee.graphql.middleware.DebugToolbarMiddleware")
...
LOGGING = {
    ...
    "formatters": {
        ...
        "json": {
            "()": "threeNineTee.core.logging.JsonFormatter",
    ...
    "loggers": {
        ...
        "threeNineTee": {"level": "DEBUG", "propagate": True},
        "threeNineTee.graphql.errors.handled": {
            "handlers": ["default"],
            "level": "ERROR",
            "propagate": False,
        },
...
TEST_RUNNER = "threeNineTee.tests.runner.PytestTestRunner"


PLAYGROUND_ENABLED = get_bool_from_env("PLAYGROUND_ENABLED", True)

'''ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,https://12e4690dc90c.ngrok.io,"))'''
...
if AWS_MEDIA_BUCKET_NAME:
    DEFAULT_FILE_STORAGE = "threeNineTee.core.storages.S3MediaStorage"
    THUMBNAIL_DEFAULT_STORAGE = DEFAULT_FILE_STORAGE
elif GS_MEDIA_BUCKET_NAME:
    DEFAULT_FILE_STORAGE = "threeNineTee.core.storages.GCSMediaStorage"
    THUMBNAIL_DEFAULT_STORAGE = DEFAULT_FILE_STORAGE
...
SEARCH_BACKEND = "threeNineTee.search.backends.postgresql"

AUTHENTICATION_BACKENDS = [
    "threeNineTee.core.auth_backend.JSONWebTokenBackend",
]
...
GRAPHENE = {
    ...
    "MIDDLEWARE": [
        "threeNineTee.graphql.middleware.OpentracingGrapheneMiddleware",
        "threeNineTee.graphql.middleware.JWTMiddleware",
        "threeNineTee.graphql.middleware.app_middleware",
    ],
}

PLUGINS_MANAGER = "threeNineTee.plugins.manager.PluginsManager"

PLUGINS = [
    "threeNineTee.plugins.avatax.plugin.AvataxPlugin",
    "threeNineTee.plugins.vatlayer.plugin.VatlayerPlugin",
    "threeNineTee.plugins.webhook.plugin.WebhookPlugin",
    "threeNineTee.payment.gateways.dummy.plugin.DummyGatewayPlugin",
    "threeNineTee.payment.gateways.dummy_credit_card.plugin.DummyCreditCardGatewayPlugin",
    "threeNineTee.payment.gateways.stripe.plugin.StripeGatewayPlugin",
    "threeNineTee.payment.gateways.braintree.plugin.BraintreeGatewayPlugin",
    "threeNineTee.payment.gateways.razorpay.plugin.RazorpayGatewayPlugin",
    "threeNineTee.payment.gateways.adyen.plugin.AdyenGatewayPlugin",
    "threeNineTee.plugins.invoicing.plugin.InvoicingPlugin",
]

# Plugin discovery
installed_plugins = pkg_resources.iter_entry_points("threeNineTee.plugins")
...
#
# Refer to our guide on https://docs.threeNineTee.io/docs/next/guides/opentracing-jaeger/.
#
