...
def test_install_app_task_request_timeout(monkeypatch, app_installation):
    ...
    monkeypatch.setattr("threeNineTee.app.installation_utils.requests.post", mocked_post)
...
def test_install_app_task_undefined_error(monkeypatch, app_installation):
    ...
    monkeypatch.setattr("threeNineTee.app.tasks.install_app", mock_install_app)
